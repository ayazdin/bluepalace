...
<ul>
	...
	<li class="listing col span_4 standard <?php if($count % 3 == 0) { echo 'first'; } ?>">
...
<a href="<?php echo the_permalink();?>">
			...
			if ( has_post_thumbnail() ) {
				...
				echo '<img class="author-img" src="' . get_template_directory_uri() . '/images/default-thumbnail.jpg' . '" />';
			}
			?>
			</a>
		</figure>
		<div class="grid-listing-info">
			<header>
				<h5 class="marB0"><a href="<?php echo the_permalink();?>"><?php echo the_title();?></a></h5>
			</header>
			<div class="propinfo">
				<p><?php
					$content = strip_tags(get_the_content());
					echo mb_substr($content, 0, 170, 'utf-8');
					?></p>
					<ul class="shareBtns">
