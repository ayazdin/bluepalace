                        ...
                        switch($field){
                            ...
                            case 'type':?>
                                <div class="form-group">
                                    <label class="form-label-static form-label-outside" for="ct_type"><?php _e('Property Type', 'contempo'); ?></label>
                            ...
                            case 'state' : ?>
                                <div class="form-group">
                                    ...
                                    <?php } else { ?>
                                        <label class="form-label-static form-label-outside"  for="ct_state"><?php _e('State', 'contempo'); ?></label>
                                    <?php } ?>
                            ...
                            case 'country' : ?>
                                <div class="form-group">
                                    <label class="form-label-static form-label-outside" for="ct_country"><?php _e('Country', 'contempo'); ?></label>
                            ...
                            /*// Price From
                            case 'price_from' : */?><!--
                                <div class="form-group priceFromHide">
...
/*                                break;
                            ...
                            // Price To
                            case 'price_to' : */?>
                                <div class="form-group priceToHide">
...
/*                                break;*/
                            ...
                            case 'keyword' : ?>
                                <div class="form-group">
                                    <label class="form-label-static form-label-outside" for="ct_keyword"><?php _e('Keyword', 'contempo'); ?></label>
            ...
            ?>
            <div class="form-group">
                <label class="form-label-static form-label-outside" for="ct_pricerange"><?php _e('Price Range', 'contempo'); ?></label>
