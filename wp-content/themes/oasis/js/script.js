...
var userAgent = navigator.userAgent.toLowerCase(),
    ...
    plugins = {
      pointerEvents: isIE < 11 ? "http://royaloasis.dev/wp-content/themes/oasis/js/pointer-events.min.js" : false,
...
$document.ready(function () {
  ...
  $document.ready(function () {
    $('.priceFromHide').hide();
    $('.priceToHide').hide();
    $("#priceRangeFromTo").change(function () {
      var range = $("#priceRangeFromTo").val().split('-');
      if ($("#priceRangeFromTo").val() != "1M") {
        var from = range[0];
        var to = range[1];
