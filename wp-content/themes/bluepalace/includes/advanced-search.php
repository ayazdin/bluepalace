...
<!--<header class="masthead">
    <h4 class="left marT0 marB0">Search Properties</h4>
    <div class="clear"></div>
</header>-->
<form id="advanced_search" name="search-listings" action="<?php echo home_url(); ?>">
    ...
    <input id="submit" class="btn left submitbutton" type="submit" value="<?php esc_html_e('Search', 'contempo'); ?>" />
